 ...
 * <ul>
 * <li>{@link org.sourcepit.modularizor.java.JavaClass#getMajor <em>Major</em>}</li>
 * <li>{@link org.sourcepit.modularizor.java.JavaClass#getMinor <em>Minor</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.sourcepit.modularizor.java.JavaModelPackage#getJavaClass()
 * @model
 * @generated
 */
public interface JavaClass extends JavaFile
{
    ...
    * @see #setMajor(int)
    * @see org.sourcepit.modularizor.java.JavaModelPackage#getJavaClass_Major()
    * @model
    * @generated
    */
   int getMajor();
   ...
   /**
    * Sets the value of the '{@link org.sourcepit.modularizor.java.JavaClass#getMajor <em>Major</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * 
    ...
    * @see #setMinor(int)
    * @see org.sourcepit.modularizor.java.JavaModelPackage#getJavaClass_Minor()
    * @model
    * @generated
    */
   int getMinor();
   ...
   /**
    * Sets the value of the '{@link org.sourcepit.modularizor.java.JavaClass#getMinor <em>Minor</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * 
