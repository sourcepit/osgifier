 ...
 * <ul>
 *   <li>{@link org.sourcepit.osgifyme.core.java.internal.impl.JavaPackageRootImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link org.sourcepit.osgifyme.core.java.internal.impl.JavaPackageRootImpl#getPath <em>Path</em>}</li>
 *   <li>{@link org.sourcepit.osgifyme.core.java.internal.impl.JavaPackageRootImpl#getRootPackages <em>Root Packages</em>}</li>
 *   <li>{@link org.sourcepit.osgifyme.core.java.internal.impl.JavaPackageRootImpl#getPackageBundle <em>Package Bundle</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JavaPackageRootImpl extends EObjectImpl implements JavaPackageRoot
{
   ...
   public EList<Annotation> getAnnotations()
   {
      if (annotations == null)
      {
         annotations = new EObjectContainmentWithInverseEList<Annotation>(Annotation.class, this, JavaModelPackage.JAVA_PACKAGE_ROOT__ANNOTATIONS, CommonModelPackage.ANNOTATION__TARGET);
      }
      return annotations;
   }
   ...
   public EList<JavaPackage> getRootPackages()
   {
      ...
      {
         rootPackages = new EObjectContainmentEList<JavaPackage>(JavaPackage.class, this, JavaModelPackage.JAVA_PACKAGE_ROOT__ROOT_PACKAGES);
      }
      return rootPackages;
   }
   ...
   {
      if (eContainerFeatureID() != JavaModelPackage.JAVA_PACKAGE_ROOT__PACKAGE_BUNDLE) return null;
   ...
   {
      msgs = eBasicSetContainer((InternalEObject)newPackageBundle, JavaModelPackage.JAVA_PACKAGE_ROOT__PACKAGE_BUNDLE, msgs);
      return msgs;
   }
   ...
   {
      if (newPackageBundle != eInternalContainer() || (eContainerFeatureID() != JavaModelPackage.JAVA_PACKAGE_ROOT__PACKAGE_BUNDLE && newPackageBundle != null))
      {
         ...
         if (newPackageBundle != null)
            msgs = ((InternalEObject)newPackageBundle).eInverseAdd(this, JavaModelPackage.JAVA_PACKAGE_BUNDLE__PACKAGE_ROOTS, JavaPackageBundle.class, msgs);
         msgs = basicSetPackageBundle(newPackageBundle, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, JavaModelPackage.JAVA_PACKAGE_ROOT__PACKAGE_BUNDLE, newPackageBundle, newPackageBundle));
   }
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
   {
      ...
      {
         case JavaModelPackage.JAVA_PACKAGE_ROOT__PACKAGE_BUNDLE:
            return eInternalContainer().eInverseRemove(this, JavaModelPackage.JAVA_PACKAGE_BUNDLE__PACKAGE_ROOTS, JavaPackageBundle.class, msgs);
      }
