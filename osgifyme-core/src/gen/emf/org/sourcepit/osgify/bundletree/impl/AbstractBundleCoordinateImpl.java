 ...
 * <ul>
 * <li>{@link org.sourcepit.osgify.bundletree.impl.AbstractBundleCoordinateImpl#getVersion <em>Version</em>}</li>
 * <li>{@link org.sourcepit.osgify.bundletree.impl.AbstractBundleCoordinateImpl#getSymbolicName <em>Symbolic Name</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public abstract class AbstractBundleCoordinateImpl extends EObjectImpl implements AbstractBundleCoordinate
{
   ...
   {
      return BundleTreeModelPackage.Literals.ABSTRACT_BUNDLE_COORDINATE;
   }
   ...
   public void setVersion(Version newVersion)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET,
            BundleTreeModelPackage.ABSTRACT_BUNDLE_COORDINATE__VERSION, oldVersion, version));
   }
   ...
   public void setSymbolicName(String newSymbolicName)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET,
            BundleTreeModelPackage.ABSTRACT_BUNDLE_COORDINATE__SYMBOLIC_NAME, oldSymbolicName, symbolicName));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType)
   {
      switch (featureID)
      {
         case BundleTreeModelPackage.ABSTRACT_BUNDLE_COORDINATE__VERSION :
            return getVersion();
         case BundleTreeModelPackage.ABSTRACT_BUNDLE_COORDINATE__SYMBOLIC_NAME :
