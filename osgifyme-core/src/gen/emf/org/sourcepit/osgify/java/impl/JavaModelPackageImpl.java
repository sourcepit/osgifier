...
import org.sourcepit.osgify.bundletree.impl.BundleTreeModelPackageImpl;
...
public class JavaModelPackageImpl extends EPackageImpl implements JavaModelPackage
{
   ...
   public static JavaModelPackage init()
   {
      ...
      BundleTreeModelPackageImpl theBundleTreeModelPackage = (BundleTreeModelPackageImpl) (EPackage.Registry.INSTANCE
         .getEPackage(BundleTreeModelPackage.eNS_URI) instanceof BundleTreeModelPackageImpl
         ? EPackage.Registry.INSTANCE.getEPackage(BundleTreeModelPackage.eNS_URI)
         : BundleTreeModelPackage.eINSTANCE);
