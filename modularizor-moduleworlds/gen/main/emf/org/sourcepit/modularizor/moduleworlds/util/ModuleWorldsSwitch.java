 ...
 * @generated
 */
public class ModuleWorldsSwitch<T> extends Switch<T>
{
   /**
   ...
   protected T doSwitch(int classifierID, EObject theEObject)
   {
      switch (classifierID)
      {
         ...
         {
            ModuleWorld moduleWorld = (ModuleWorld) theEObject;
            T result = caseModuleWorld(moduleWorld);
            if (result == null)
               result = caseXAnnotatable(moduleWorld);
            if (result == null)
               result = caseExtendable(moduleWorld);
            if (result == null)
               result = caseAnnotatable(moduleWorld);
            if (result == null)
         ...
         case ModuleWorldsPackage.ABSTRACT_MODULE :
         {
            AbstractModule abstractModule = (AbstractModule) theEObject;
            T result = caseAbstractModule(abstractModule);
            if (result == null)
               result = caseXAnnotatable(abstractModule);
            if (result == null)
               result = caseExtendable(abstractModule);
            if (result == null)
         ...
         {
            AssembledModule assembledModule = (AssembledModule) theEObject;
            T result = caseAssembledModule(assembledModule);
            if (result == null)
               result = caseAbstractModule(assembledModule);
            if (result == null)
               result = caseXAnnotatable(assembledModule);
            if (result == null)
               result = caseExtendable(assembledModule);
            if (result == null)
               result = caseAnnotatable(assembledModule);
            if (result == null)
               result = defaultCase(theEObject);
            return result;
         }
         ...
         {
            ExplodedModule explodedModule = (ExplodedModule) theEObject;
            T result = caseExplodedModule(explodedModule);
            if (result == null)
               result = caseAbstractModule(explodedModule);
            if (result == null)
               result = caseXAnnotatable(explodedModule);
            if (result == null)
               result = caseExtendable(explodedModule);
            if (result == null)
               result = caseAnnotatable(explodedModule);
            if (result == null)
               result = defaultCase(theEObject);
            return result;
         }
   ...
   /**
    * Returns the result of interpreting the object as an instance of '<em>Module World</em>'.
    * <!-- begin-user-doc -->
    ...
    * @return the result of interpreting the object as an instance of '<em>Module World</em>'.
    * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
    * @generated
    */
   public T caseModuleWorld(ModuleWorld object)
   {
      return null;
   }
   ...
   /**
    * Returns the result of interpreting the object as an instance of '<em>Assembled Module</em>'.
    * <!-- begin-user-doc -->
    * This implementation returns null;
    * returning a non-null result will terminate the switch.
    * <!-- end-user-doc -->
    * 
    * @param object the target of the switch.
    * @return the result of interpreting the object as an instance of '<em>Assembled Module</em>'.
    * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
    * @generated
    */
   public T caseAssembledModule(AssembledModule object)
   {
      return null;
   }

   /**
    * Returns the result of interpreting the object as an instance of '<em>Exploded Module</em>'.
    * <!-- begin-user-doc -->
    * This implementation returns null;
    * returning a non-null result will terminate the switch.
    * <!-- end-user-doc -->
    * 
    * @param object the target of the switch.
    * @return the result of interpreting the object as an instance of '<em>Exploded Module</em>'.
    * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
    * @generated
    */
   public T caseExplodedModule(ExplodedModule object)
   {
      return null;
   }
