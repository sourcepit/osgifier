   ...
   protected T doSwitch(int classifierID, EObject theEObject)
   {
      switch (classifierID)
      {
         ...
         case JavaModelPackage.RESOURCE:
         {
            ...
            if (result == null) result = caseXAnnotatable(resource);
            if (result == null) result = caseExtendable(resource);
            if (result == null) result = caseAnnotatable(resource);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case JavaModelPackage.DIRECTORY:
         {
            ...
            if (result == null) result = caseResource(directory);
            if (result == null) result = caseNamed(directory);
            if (result == null) result = caseXAnnotatable(directory);
            if (result == null) result = caseExtendable(directory);
            if (result == null) result = caseAnnotatable(directory);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case JavaModelPackage.FILE:
         {
            ...
            if (result == null) result = caseXAnnotatable(file);
            if (result == null) result = caseExtendable(file);
            if (result == null) result = caseAnnotatable(file);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case JavaModelPackage.JAVA_ELEMENT:
         {
            ...
            if (result == null) result = caseNamed(javaElement);
            if (result == null) result = caseXAnnotatable(javaElement);
            if (result == null) result = caseExtendable(javaElement);
            if (result == null) result = caseAnnotatable(javaElement);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case JavaModelPackage.QUALIFIED_JAVA_ELEMENT:
         {
            ...
            if (result == null) result = caseJavaElement(qualifiedJavaElement);
            if (result == null) result = caseNamed(qualifiedJavaElement);
            if (result == null) result = caseXAnnotatable(qualifiedJavaElement);
            if (result == null) result = caseExtendable(qualifiedJavaElement);
            if (result == null) result = caseAnnotatable(qualifiedJavaElement);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case JavaModelPackage.JAVA_RESOURCE_BUNDLE:
         {
            ...
            if (result == null) result = caseJavaElement(javaResourceBundle);
            if (result == null) result = caseNamed(javaResourceBundle);
            if (result == null) result = caseXAnnotatable(javaResourceBundle);
            if (result == null) result = caseExtendable(javaResourceBundle);
            if (result == null) result = caseAnnotatable(javaResourceBundle);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case JavaModelPackage.JAVA_PROJECT:
         {
            ...
            if (result == null) result = caseJavaResourceBundle(javaProject);
            if (result == null) result = caseJavaElement(javaProject);
            if (result == null) result = caseNamed(javaProject);
            if (result == null) result = caseXAnnotatable(javaProject);
            if (result == null) result = caseExtendable(javaProject);
         ...
         case JavaModelPackage.JAVA_ARCHIVE:
         {
            ...
            if (result == null) result = caseJavaResourceBundle(javaArchive);
            if (result == null) result = caseJavaElement(javaArchive);
            if (result == null) result = caseNamed(javaArchive);
            if (result == null) result = caseXAnnotatable(javaArchive);
            if (result == null) result = caseExtendable(javaArchive);
         ...
         case JavaModelPackage.JAVA_RESOURCE_DIRECTORY:
         {
            ...
            if (result == null) result = caseJavaElement(javaResourceDirectory);
            if (result == null) result = caseDirectory(javaResourceDirectory);
            if (result == null) result = caseResource(javaResourceDirectory);
            if (result == null) result = caseNamed(javaResourceDirectory);
            if (result == null) result = caseXAnnotatable(javaResourceDirectory);
            if (result == null) result = caseExtendable(javaResourceDirectory);
            if (result == null) result = caseAnnotatable(javaResourceDirectory);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case JavaModelPackage.JAVA_RESOURCES_ROOT:
         {
            ...
            if (result == null) result = caseJavaResourceDirectory(javaResourcesRoot);
            if (result == null) result = caseJavaElement(javaResourcesRoot);
            if (result == null) result = caseDirectory(javaResourcesRoot);
            if (result == null) result = caseResource(javaResourcesRoot);
            if (result == null) result = caseNamed(javaResourcesRoot);
            if (result == null) result = caseXAnnotatable(javaResourcesRoot);
            if (result == null) result = caseExtendable(javaResourcesRoot);
            if (result == null) result = caseAnnotatable(javaResourcesRoot);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case JavaModelPackage.JAVA_PACKAGE:
         {
            ...
            if (result == null) result = caseJavaResource(javaPackage);
            if (result == null) result = caseQualifiedJavaElement(javaPackage);
            if (result == null) result = caseJavaResourceDirectory(javaPackage);
            if (result == null) result = caseJavaElement(javaPackage);
            if (result == null) result = caseDirectory(javaPackage);
            if (result == null) result = caseResource(javaPackage);
            if (result == null) result = caseNamed(javaPackage);
            if (result == null) result = caseXAnnotatable(javaPackage);
            if (result == null) result = caseExtendable(javaPackage);
         ...
         case JavaModelPackage.JAVA_FILE:
         {
            ...
            if (result == null) result = caseJavaResource(javaFile);
            if (result == null) result = caseFile(javaFile);
            if (result == null) result = caseResource(javaFile);
            if (result == null) result = caseJavaElement(javaFile);
            if (result == null) result = caseNamed(javaFile);
            if (result == null) result = caseXAnnotatable(javaFile);
            if (result == null) result = caseExtendable(javaFile);
            if (result == null) result = caseAnnotatable(javaFile);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case JavaModelPackage.JAVA_CLASS:
         {
            ...
            if (result == null) result = caseJavaFile(javaClass);
            if (result == null) result = caseJavaResource(javaClass);
            if (result == null) result = caseFile(javaClass);
            if (result == null) result = caseResource(javaClass);
            if (result == null) result = caseJavaElement(javaClass);
            if (result == null) result = caseNamed(javaClass);
            if (result == null) result = caseXAnnotatable(javaClass);
            if (result == null) result = caseExtendable(javaClass);
         ...
         case JavaModelPackage.JAVA_COMPILATION_UNIT:
         {
            ...
            if (result == null) result = caseJavaFile(javaCompilationUnit);
            if (result == null) result = caseJavaResource(javaCompilationUnit);
            if (result == null) result = caseFile(javaCompilationUnit);
            if (result == null) result = caseResource(javaCompilationUnit);
            if (result == null) result = caseJavaElement(javaCompilationUnit);
            if (result == null) result = caseNamed(javaCompilationUnit);
            if (result == null) result = caseXAnnotatable(javaCompilationUnit);
            if (result == null) result = caseExtendable(javaCompilationUnit);
         ...
         case JavaModelPackage.IMPORT_DECLARATION:
         {
            ...
            if (result == null) result = caseJavaElement(importDeclaration);
            if (result == null) result = caseNamed(importDeclaration);
            if (result == null) result = caseXAnnotatable(importDeclaration);
            if (result == null) result = caseExtendable(importDeclaration);
         ...
         case JavaModelPackage.JAVA_TYPE:
         {
            ...
            if (result == null) result = caseQualifiedJavaElement(javaType);
            if (result == null) result = caseJavaElement(javaType);
            if (result == null) result = caseNamed(javaType);
            if (result == null) result = caseXAnnotatable(javaType);
            if (result == null) result = caseExtendable(javaType);
         ...
         case JavaModelPackage.JAVA_RESOURCE:
         {
            ...
            if (result == null) result = caseResource(javaResource);
            if (result == null) result = caseJavaElement(javaResource);
            if (result == null) result = caseNamed(javaResource);
            if (result == null) result = caseXAnnotatable(javaResource);
            if (result == null) result = caseExtendable(javaResource);
            if (result == null) result = caseAnnotatable(javaResource);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
