 ...
 * <ul>
 * <li>{@link org.sourcepit.osgify.core.model.java.JavaClass#getMajor <em>Major</em>}</li>
 * <li>{@link org.sourcepit.osgify.core.model.java.JavaClass#getMinor <em>Minor</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.sourcepit.osgify.core.model.java.JavaModelPackage#getJavaClass()
 * @model
 * @generated
 */
public interface JavaClass extends JavaFile
{
    ...
    * @see #setMajor(int)
    * @see org.sourcepit.osgify.core.model.java.JavaModelPackage#getJavaClass_Major()
    * @model
    * @generated
    */
   int getMajor();
   ...
   /**
    * Sets the value of the '{@link org.sourcepit.osgify.core.model.java.JavaClass#getMajor <em>Major</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * 
    ...
    * @see #setMinor(int)
    * @see org.sourcepit.osgify.core.model.java.JavaModelPackage#getJavaClass_Minor()
    * @model
    * @generated
    */
   int getMinor();
   ...
   /**
    * Sets the value of the '{@link org.sourcepit.osgify.core.model.java.JavaClass#getMinor <em>Minor</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * 
