 ...
 *   <li>{@link org.sourcepit.osgify.core.model.java.impl.ImportDeclarationImpl#getCompilationUnit <em>Compilation Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ImportDeclarationImpl extends EObjectImpl implements ImportDeclaration
{
   ...
   public EList<EObject> getExtensions()
   {
      if (extensions == null)
      {
         extensions = new EObjectContainmentEList<EObject>(EObject.class, this, JavaModelPackage.IMPORT_DECLARATION__EXTENSIONS);
      }
      return extensions;
   }
   ...
   public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
   {
      if (baseClass == Extendable.class)
      {
         ...
         {
            case JavaModelPackage.IMPORT_DECLARATION__EXTENSIONS: return CommonModelPackage.EXTENDABLE__EXTENSIONS;
            default: return -1;
         }
      }
      if (baseClass == Annotatable.class)
      {
         switch (derivedFeatureID)
         {
            case JavaModelPackage.IMPORT_DECLARATION__ANNOTATIONS: return CommonModelPackage.ANNOTATABLE__ANNOTATIONS;
            default: return -1;
         }
      }
   ...
   public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
   {
      if (baseClass == Extendable.class)
      {
         ...
         {
            case CommonModelPackage.EXTENDABLE__EXTENSIONS: return JavaModelPackage.IMPORT_DECLARATION__EXTENSIONS;
            default: return -1;
         }
      }
      if (baseClass == Annotatable.class)
      {
         switch (baseFeatureID)
         {
            case CommonModelPackage.ANNOTATABLE__ANNOTATIONS: return JavaModelPackage.IMPORT_DECLARATION__ANNOTATIONS;
            default: return -1;
         }
      }
      if (baseClass == XAnnotatable.class)
