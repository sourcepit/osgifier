   ...
   protected T doSwitch(int classifierID, EObject theEObject)
   {
      switch (classifierID)
      {
         case MavenModelPackage.MAVEN_ARTIFACT:
         {
            ...
            if (result == null) result = caseVersionedIdentifiable(mavenArtifact);
            if (result == null) result = caseClassified(mavenArtifact);
            if (result == null) result = caseIdentifiable(mavenArtifact);
         ...
         case MavenModelPackage.MAVEN_DEPENDENCY:
         {
            ...
            if (result == null) result = caseIdentifiable(mavenDependency);
            if (result == null) result = caseClassified(mavenDependency);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         ...
         case MavenModelPackage.VERSIONED_IDENTIFIABLE:
         {
            ...
            if (result == null) result = caseIdentifiable(versionedIdentifiable);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         ...
         case MavenModelPackage.MAVEN_PROJECT:
         {
            ...
            if (result == null) result = caseVersionedIdentifiable(mavenProject);
            if (result == null) result = caseIdentifiable(mavenProject);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
