...
public class MavenModelPackageImpl extends EPackageImpl implements MavenModelPackage
{
    ...
    * @see org.sourcepit.osgify.maven.model.maven.MavenModelPackage#eNS_URI
    * @see #init()
    * @generated
    */
    ...
    * 
    * <p>This method is used to initialize {@link MavenModelPackage#eINSTANCE} when that field is accessed.
   ...
   {
      if (isInited) return (MavenModelPackage)EPackage.Registry.INSTANCE.getEPackage(MavenModelPackage.eNS_URI);

      // Obtain or create and register package
      MavenModelPackageImpl theMavenModelPackage = (MavenModelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof MavenModelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new MavenModelPackageImpl());
   ...
   public void initializePackageContents()
   {
      ...
      initEAttribute(getMavenArtifact_File(), theCommonModelPackage.getEJavaFile(), "file", null, 0, 1, MavenArtifact.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      ...
      initEAttribute(getMavenDependency_VersionRange(), ecorePackage.getEString(), "versionRange", null, 0, 1, MavenDependency.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getMavenDependency_Scope(), ecorePackage.getEString(), "scope", "compile", 0, 1, MavenDependency.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getMavenDependency_Optional(), ecorePackage.getEBoolean(), "optional", null, 0, 1, MavenDependency.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(identifiableEClass, Identifiable.class, "Identifiable", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getIdentifiable_GroupId(), ecorePackage.getEString(), "groupId", null, 1, 1, Identifiable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getIdentifiable_ArtifactId(), ecorePackage.getEString(), "artifactId", null, 1, 1, Identifiable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(versionedIdentifiableEClass, VersionedIdentifiable.class, "VersionedIdentifiable", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getVersionedIdentifiable_Version(), ecorePackage.getEString(), "version", null, 1, 1, VersionedIdentifiable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(classifiedEClass, Classified.class, "Classified", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getClassified_Classifier(), ecorePackage.getEString(), "classifier", null, 0, 1, Classified.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getClassified_Type(), ecorePackage.getEString(), "type", "jar", 0, 1, Classified.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEClass(mavenProjectEClass, MavenProject.class, "MavenProject", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getMavenProject_Packaging(), ecorePackage.getEString(), "packaging", "jar", 0, 1, MavenProject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getMavenProject_PomFile(), theCommonModelPackage.getEJavaFile(), "pomFile", null, 0, 1, MavenProject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      addEOperation(mavenProjectEClass, theCommonModelPackage.getEJavaFile(), "getProjectDir", 0, 1, IS_UNIQUE, IS_ORDERED);
