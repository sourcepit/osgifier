 ...
 * <ul>
 *   <li>{@link org.sourcepit.osgify.maven.model.maven.impl.MavenProjectImpl#getPackaging <em>Packaging</em>}</li>
 *   <li>{@link org.sourcepit.osgify.maven.model.maven.impl.MavenProjectImpl#getPomFile <em>Pom File</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MavenProjectImpl extends VersionedIdentifiableImpl implements MavenProject
{
   ...
   public void setPackaging(String newPackaging)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, MavenModelPackage.MAVEN_PROJECT__PACKAGING, oldPackaging, packaging));
   }
   ...
   public void setPomFile(File newPomFile)
   {
      ...
      pomFile = newPomFile;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, MavenModelPackage.MAVEN_PROJECT__POM_FILE, oldPomFile, pomFile));
   }
