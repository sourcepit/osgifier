 ...
 * <ul>
 *   <li>{@link org.sourcepit.osgify.maven.model.maven.impl.MavenDependencyImpl#getClassifier <em>Classifier</em>}</li>
 *   <li>{@link org.sourcepit.osgify.maven.model.maven.impl.MavenDependencyImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.sourcepit.osgify.maven.model.maven.impl.MavenDependencyImpl#getVersionRange <em>Version Range</em>}</li>
 *   <li>{@link org.sourcepit.osgify.maven.model.maven.impl.MavenDependencyImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link org.sourcepit.osgify.maven.model.maven.impl.MavenDependencyImpl#isOptional <em>Optional</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MavenDependencyImpl extends IdentifiableImpl implements MavenDependency
{
   ...
   public void setClassifier(String newClassifier)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, MavenModelPackage.MAVEN_DEPENDENCY__CLASSIFIER, oldClassifier, classifier));
   }
   ...
   public void setVersionRange(String newVersionRange)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, MavenModelPackage.MAVEN_DEPENDENCY__VERSION_RANGE, oldVersionRange, versionRange));
   }
   ...
   public void setScope(String newScope)
   {
      ...
      scope = newScope;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, MavenModelPackage.MAVEN_DEPENDENCY__SCOPE, oldScope, scope));
   }
   ...
   public void setOptional(boolean newOptional)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, MavenModelPackage.MAVEN_DEPENDENCY__OPTIONAL, oldOptional, optional));
   }
   ...
   public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
   {
      if (baseClass == Classified.class)
      {
         ...
         {
            case MavenModelPackage.MAVEN_DEPENDENCY__CLASSIFIER: return MavenModelPackage.CLASSIFIED__CLASSIFIER;
            case MavenModelPackage.MAVEN_DEPENDENCY__TYPE: return MavenModelPackage.CLASSIFIED__TYPE;
            default: return -1;
         }
      }
   ...
   public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
   {
      if (baseClass == Classified.class)
      {
         ...
         {
            case MavenModelPackage.CLASSIFIED__CLASSIFIER: return MavenModelPackage.MAVEN_DEPENDENCY__CLASSIFIER;
            case MavenModelPackage.CLASSIFIED__TYPE: return MavenModelPackage.MAVEN_DEPENDENCY__TYPE;
            default: return -1;
         }
      }
