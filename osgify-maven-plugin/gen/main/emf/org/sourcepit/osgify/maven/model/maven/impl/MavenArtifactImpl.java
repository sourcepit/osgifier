 ...
 * <ul>
 *   <li>{@link org.sourcepit.osgify.maven.model.maven.impl.MavenArtifactImpl#getClassifier <em>Classifier</em>}</li>
 *   <li>{@link org.sourcepit.osgify.maven.model.maven.impl.MavenArtifactImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.sourcepit.osgify.maven.model.maven.impl.MavenArtifactImpl#getFile <em>File</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MavenArtifactImpl extends VersionedIdentifiableImpl implements MavenArtifact
{
   ...
   public void setClassifier(String newClassifier)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, MavenModelPackage.MAVEN_ARTIFACT__CLASSIFIER, oldClassifier, classifier));
   }
   ...
   public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
   {
      if (baseClass == Classified.class)
      {
         ...
         {
            case MavenModelPackage.MAVEN_ARTIFACT__CLASSIFIER: return MavenModelPackage.CLASSIFIED__CLASSIFIER;
            case MavenModelPackage.MAVEN_ARTIFACT__TYPE: return MavenModelPackage.CLASSIFIED__TYPE;
            default: return -1;
         }
      }
   ...
   public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
   {
      if (baseClass == Classified.class)
      {
         ...
         {
            case MavenModelPackage.CLASSIFIED__CLASSIFIER: return MavenModelPackage.MAVEN_ARTIFACT__CLASSIFIER;
            case MavenModelPackage.CLASSIFIED__TYPE: return MavenModelPackage.MAVEN_ARTIFACT__TYPE;
            default: return -1;
         }
      }
