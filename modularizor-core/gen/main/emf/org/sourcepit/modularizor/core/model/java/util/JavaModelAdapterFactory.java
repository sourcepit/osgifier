...
public class JavaModelAdapterFactory extends AdapterFactoryImpl
{
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.modularizor.core.model.java.Named
    * <em>Named</em>}'.
    * <!-- begin-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.modularizor.core.model.java.Resource
    * <em>Resource</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.modularizor.core.model.java.Directory
    * <em>Directory</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.modularizor.core.model.java.File <em>File</em>}
    * '.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.modularizor.core.model.java.JavaElement
    * <em>Java Element</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    ...
    * {@link org.sourcepit.modularizor.core.model.java.QualifiedJavaElement <em>Qualified Java Element</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.modularizor.core.model.java.JavaResourceBundle
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.modularizor.core.model.java.JavaProject
    * <em>Java Project</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.modularizor.core.model.java.JavaArchive
    * <em>Java Archive</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
   ...
   /**
    * Creates a new adapter for an object of class '
    * {@link org.sourcepit.modularizor.core.model.java.JavaResourceDirectory <em>Java Resource Directory</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.modularizor.core.model.java.JavaResourcesRoot
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.modularizor.core.model.java.JavaPackage
    * <em>Java Package</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.modularizor.core.model.java.JavaFile
    * <em>Java File</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.modularizor.core.model.java.JavaClass
    * <em>Java Class</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
   ...
   /**
    * Creates a new adapter for an object of class '
    * {@link org.sourcepit.modularizor.core.model.java.JavaCompilationUnit <em>Java Compilation Unit</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.modularizor.core.model.java.ImportDeclaration
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.modularizor.core.model.java.JavaType
    * <em>Java Type</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.modularizor.core.model.java.JavaResource
    * <em>Java Resource</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.modularizor.core.model.java.ResourceVisitor
