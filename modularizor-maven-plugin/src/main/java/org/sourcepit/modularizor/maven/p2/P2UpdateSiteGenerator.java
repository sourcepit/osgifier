...
import static org.sourcepit.modularizor.maven.p2.BundleSelectorUtils.selectBundles;
...
import org.sourcepit.modularizor.maven.context.OsgifyModelBuilder.NativeBundleStrategy;
import org.sourcepit.modularizor.p2.P2Publisher;
...
public class P2UpdateSiteGenerator
{
   ...
   @Inject
   private org.sourcepit.modularizor.maven.OsgifyModelBuilder modelBuilder2;
